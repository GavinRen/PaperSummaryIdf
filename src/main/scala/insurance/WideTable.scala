...
//  根据prpcopymain批改次数是否为0，联共标志和联共比例生成一列原始保费
  def RawPremium(df:DataFrame,Validdate:String,UnderWriteFlag:String,chargeFlag:String,cancelFlag:String,CoinsFlag:String,CoinsRate:String,sumPremium:String,rawPremium:String):DataFrame={
